...
static inline float inv_ln2(void) { return 1.4426950408889634f; }
...
float ts_analysis_calculate_finger_balance_score(void) { return 0.5f; }
uint32_t ts_analysis_count_alternating_hands(void) { return 0; }
float ts_analysis_calculate_typing_rhythm_variance(void) { return 0.0f; }
#endif
